...
export const Answer = ({ answer, onCitationClicked, onExectResultClicked, isStreaming = false }: Props) => {
  ...
  const parsedAnswer = useMemo(() => parseAnswer(answer, isStreaming), [answer, isStreaming])
